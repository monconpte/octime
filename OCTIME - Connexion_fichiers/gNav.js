...
function GNAV_COMPLETECARACTERENAV(Vf_ch,Vf_taille,Vf_caract,Vf_gauche){if(Vf_caract===void 0){Vf_caract=" ";}if(Vf_gauche===void 0){Vf_gauche=false;}try{clWDUtil.Try();{var Vl_i=0;var Vl_ch=clWDUtil.oConversionType(Vf_ch,19,0,50,0);var Vl_tailleIni=clWDUtil.oConversionType(String(Vl_ch).length,19,0,8,0);if(clWDUtil.bComparaison(clWDUtil.oChaineVersNumerique(Vf_taille),clWDUtil.oChaineVersNumerique(Vl_tailleIni),false,true,false,false)){var V1688350160=clWDUtil.oSoustraction(clWDUtil.oChaineVersNumerique(Vf_taille),clWDUtil.oChaineVersNumerique(Vl_tailleIni));for(Vl_i=1;Vl_i<=V1688350160;Vl_i++){if(Vf_gauche){Vl_ch=clWDUtil.oConversionType(clWDUtil.oAddition(Vf_caract,Vl_ch),19,0,50,0);}else {Vl_ch=clWDUtil.oAddition(Vl_ch,Vf_caract);}}}else {if(Vf_gauche){Vl_ch=clWDUtil.oConversionType(clWDUtil.sDroite(Vl_ch,clWDUtil.oChaineVersNumerique(Vf_taille)),19,0,31,0);}else {Vl_ch=clWDUtil.oConversionType((Vl_ch+"").substring(0,clWDUtil.oChaineVersNumerique(Vf_taille)),19,0,31,0);}}clWDUtil.Renvoyer(Vl_ch);return;}}catch(_E){clWDUtil.xbCatchThrow(_E);return;}finally{return clWDUtil&&clWDUtil.oFinally();}}
function GNAV_MASQUEDESAISIENUM(Vf_chaine,Vf_reel,Vf_nb_decimale){if(Vf_reel===void 0){Vf_reel=false;}if(Vf_nb_decimale===void 0){Vf_nb_decimale=2;}try{clWDUtil.Try();{var V1688357936=(Vf_chaine + "").substr(clWDUtil.oConversionType(String(Vf_chaine).length,8,0,8,0)-1, 1);if((clWDUtil.bComparaison(V1688357936,"+",true,false,false,false))||(clWDUtil.bComparaison(V1688357936,"-",true,false,false,false))||(clWDUtil.bComparaison(V1688357936,"/",true,false,false,false))||(clWDUtil.bComparaison(V1688357936,"*",true,false,false,false))||(clWDUtil.bComparaison(V1688357936," ",true,false,false,false))){Vf_chaine=(Vf_chaine + "").substr(0, (clWDUtil.oConversionType(String(Vf_chaine).length,8,0,8,0)-1));}else if((clWDUtil.bComparaison(V1688357936,",",true,false,false,false))||(clWDUtil.bComparaison(V1688357936,".",true,false,false,false))){if(Vf_reel){if((clWDUtil.oConversionType(Position(Vf_chaine,",",0),8,0,8,0)==0)){Vf_chaine=clWDUtil.oAddition((Vf_chaine + "").substr(0, (clWDUtil.oConversionType(String(Vf_chaine).length,8,0,8,0)-1)),",");}else {Vf_chaine=(Vf_chaine + "").substr(0, (clWDUtil.oConversionType(String(Vf_chaine).length,8,0,8,0)-1));}}else {Vf_chaine=(Vf_chaine + "").substr(0, (clWDUtil.oConversionType(String(Vf_chaine).length,8,0,8,0)-1));}}else {if((Vf_reel&&(clWDUtil.oConversionType(Position(Vf_chaine,",",0),8,0,8,0)!=0))){Vf_chaine=(Vf_chaine + "").substr(0, clWDUtil.oAddition(clWDUtil.oConversionType(Position(Vf_chaine,",",0),8,0,8,0),Vf_nb_decimale));}}clWDUtil.Renvoyer(Vf_chaine);return;}}catch(_E){clWDUtil.xbCatchThrow(_E);return;}finally{return clWDUtil&&clWDUtil.oFinally();}}
...
function GNAV_DICTIONNAIRENAV(Vf_message){try{clWDUtil.Try();{var V1688361584=Vf_message;if(clWDUtil.bComparaison(V1688361584,"Tri",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_00000071_);return;}else if(clWDUtil.bComparaison(V1688361584,"AVPHO",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_00000069_);return;}else if(clWDUtil.bComparaison(V1688361584,"CONT",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_0000006A_);return;}else if(clWDUtil.bComparaison(V1688361584,"EMP",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_00000064_);return;}else if(clWDUtil.bComparaison(V1688361584,"MAT",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_00000065_);return;}else if(clWDUtil.bComparaison(V1688361584,"DEB",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_0000006B_);return;}else if(clWDUtil.bComparaison(V1688361584,"FIN",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_0000006C_);return;}else if(clWDUtil.bComparaison(V1688361584,"SEL",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_0000006D_);return;}else if(clWDUtil.bComparaison(V1688361584,"NOPRE",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_0000006E_);return;}else if(clWDUtil.bComparaison(V1688361584,"PMAT",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_0000006F_);return;}else if(clWDUtil.bComparaison(V1688361584,"PBAD",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_00000070_);return;}else if(clWDUtil.bComparaison(V1688361584,"BAD",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_00000066_);return;}else if(clWDUtil.bComparaison(V1688361584,"PHO",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_00000067_);return;}else if(clWDUtil.bComparaison(V1688361584,"MP_ACC",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_00000056_);return;}else if(clWDUtil.bComparaison(V1688361584,"MP_AIDE",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_00000057_);return;}else if(clWDUtil.bComparaison(V1688361584,"MP_DECO",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_00000058_);return;}else if(clWDUtil.bComparaison(V1688361584,"MP_CALDIFF",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_00000052_);return;}else if(clWDUtil.bComparaison(V1688361584,"MP_CALAUTO",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_00000053_);return;}else if(clWDUtil.bComparaison(V1688361584,"CSEL",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_00000051_);return;}else if(clWDUtil.bComparaison(V1688361584,"CCOUL",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_00000054_);return;}else if(clWDUtil.bComparaison(V1688361584,"CDEF",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_0000004F_);return;}else if(clWDUtil.bComparaison(V1688361584,"FAV",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_0000004E_);return;}else if(clWDUtil.bComparaison(V1688361584,"PHOR",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_00000041_);return;}else if(clWDUtil.bComparaison(V1688361584,"PABS",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_00000042_);return;}else if(clWDUtil.bComparaison(V1688361584,"PACT",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_00000043_);return;}else if(clWDUtil.bComparaison(V1688361584,"PPEX",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_00000044_);return;}else if(clWDUtil.bComparaison(V1688361584,"PREG",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_00000045_);return;}else if(clWDUtil.bComparaison(V1688361584,"PNIV",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_00000046_);return;}else if(clWDUtil.bComparaison(V1688361584,"VEUP",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_00000047_);return;}else if(clWDUtil.bComparaison(V1688361584,"OUI",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_0000004B_);return;}else if(clWDUtil.bComparaison(V1688361584,"NON",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_0000004A_);return;}else if(clWDUtil.bComparaison(V1688361584,"ANNUL",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_00000049_);return;}else if(clWDUtil.bComparaison(V1688361584,"OK",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_00000048_);return;}else if(clWDUtil.bComparaison(V1688361584,"CAL",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_0000004C_);return;}else if(clWDUtil.bComparaison(V1688361584,"DEF",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_0000004D_);return;}else if(clWDUtil.bComparaison(V1688361584,"VAL",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_00000055_);return;}else if(clWDUtil.bComparaison(V1688361584,"VISUCPT",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_0000005A_);return;}else if(clWDUtil.bComparaison(V1688361584,"HOR_EVT",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_0000005C_);return;}else if(clWDUtil.bComparaison(V1688361584,"SUPP",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_0000005D_);return;}else if(clWDUtil.bComparaison(V1688361584,"DOS",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_0000005E_);return;}else if(clWDUtil.bComparaison(V1688361584,"NDD",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_0000005F_);return;}else if(clWDUtil.bComparaison(V1688361584,"NDF",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_00000060_);return;}else if(clWDUtil.bComparaison(V1688361584,"GDF",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_00000061_);return;}else if(clWDUtil.bComparaison(V1688361584,"AF",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_00000062_);return;}else if(clWDUtil.bComparaison(V1688361584,"SMF",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_00000063_);return;}else if(clWDUtil.bComparaison(V1688361584,"NOATOHOR",true,false,false,false)){clWDUtil.Renvoyer(_ML3FCF18514BF1598C_00000072_);return;}else {clWDUtil.Renvoyer("");return;}}}catch(_E){clWDUtil.xbCatchThrow(_E);return;}finally{return clWDUtil&&clWDUtil.oFinally();}}
...
function GNAV_RECUPCSTCOULEUR(Vf_nomCoul){try{clWDUtil.Try();{var V1688361488=Vf_nomCoul;if(clWDUtil.bComparaison(V1688361488,"Blanc_HEXA",true,false,false,false)){clWDUtil.Renvoyer("#FFFFFF");return;}else if(clWDUtil.bComparaison(V1688361488,"TxtS001_HEXA",true,false,false,false)){clWDUtil.Renvoyer("#505458");return;}else if(clWDUtil.bComparaison(V1688361488,"TxtBleuLienS004_HEXA",true,false,false,false)){clWDUtil.Renvoyer("#137AEC");return;}else if(clWDUtil.bComparaison(V1688361488,"FondMenuContext_HEXA",true,false,false,false)){clWDUtil.Renvoyer("#E6F0FA");return;}else if(clWDUtil.bComparaison(V1688361488,"TxtAccentueS009_HEXA",true,false,false,false)){clWDUtil.Renvoyer("#282C30");return;}else if(clWDUtil.bComparaison(V1688361488,"TxtGriseS100_HEXA",true,false,false,false)){clWDUtil.Renvoyer("#A0A4A8");return;}else if(clWDUtil.bComparaison(V1688361488,"FondJauge_HEXA",true,false,false,false)){clWDUtil.Renvoyer("#A1CAF7");return;}else if(clWDUtil.bComparaison(V1688361488,"FondTrace_HEXA",true,false,false,false)){clWDUtil.Renvoyer("#FFD263");return;}else {}clWDUtil.Renvoyer("#505458");return;}}catch(_E){clWDUtil.xbCatchThrow(_E);return;}finally{return clWDUtil&&clWDUtil.oFinally();}}
...
function GI_IFrameDebutDrag()
{
	...
	$("#CELL_IFRAME_PAGE_IFRAME_MULTI_" + gf_numIFramePage).append("<div style='position:absolute; top:0; left:0; width:100%; height:100%;'>&nbsp;</div>");
}
...
function GI_IFrameFinDrag()
{
	...
	$("#CELL_IFRAME_PAGE_IFRAME_MULTI_" + gf_numIFramePage).children().remove("div");
}
